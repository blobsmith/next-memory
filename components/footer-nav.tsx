      ...
      <div className="container-fluid">
        <div className="row">
            <div className="col-md-10">
                ...
                <span className="copyright">Copyrights ©{new Date().getFullYear()} - OlivierG.</span>
            </div>
            <div className="col-md-2 icons-container" >
                <div className="icons" >
                    <Link href="https://www.linkedin.com/in/gilbertolivier/">
                        <a target="_blank" className="logo-svg">
